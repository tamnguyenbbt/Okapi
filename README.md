...
* Auto and manual Page Object Model class code generation capability/web object detection with color highlight on browser. Supports reusable web driver from another execution session, making it easy for recording web objects to build accurate web object repository in minutes (than hours or days of manual building web object repository)
* Realiable
...
## NuGet
* https://www.nuget.org/packages/Okapi/1.1.14
* Install-Package Okapi -Version 1.1.14
...
## Versions
* Version **1.1.14** released on 04/16/2019
